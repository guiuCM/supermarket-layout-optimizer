package domain.algorithms.unit.simultaneous.TSP;
...
public class driverAlgorithmsTSP {
    ...
    public void init() {
        ...
        test13cities(); // min 185
        test14cities(); // min 650
        test15cities(); // min 291
        test16cities(); // ???????????
        test17cities(); // min 2085
        test18cities();
        test19cities();
        test20cities();
        test26cities(); // min 937
    }
