package domain.algorithms.unit.separated.QAP;

import domain.algorithms.AlgoritmoFactory;
import org.junit.Test;
import util.AlgoritmosQAP;

public class driverSimulatedAnnealingQAP {
    ...
    public void init() {
        ...
        System.out.println(BLUE + "===========================================" + RESET);
        System.out.print(BLUE + "|" + RESET);
        System.out.print(MAGENTA + "      Simulated Annealing QAP Driver     " + RESET);
        System.out.println(BLUE + "|" + RESET);
        System.out.println(BLUE + "===========================================" + RESET);
    ...
    void test4productos1() {
        ...
        int numBaldas = 1;
        AlgoritmoFactory.obtenerMinDistribucionVecinos(AlgoritmosQAP.SIMULATED_ANNEALING, numProductos, numBaldas, productos, m);
