package domain.algorithms.unit.separated.TSP;
...
public class driverChristofidesTSP {
    ...
    public void init() {
        ...
        System.out.println(BLUE + "===========================================" + RESET);
        System.out.print(BLUE + "|" + RESET);
        System.out.print(MAGENTA + "          Christofides TSP Driver        " + RESET);
        System.out.println(BLUE + "|" + RESET);
        System.out.println(BLUE + "===========================================" + RESET);
    ...
    void test4productos1() {
        ...
        int numBaldas = 1;
        AlgoritmoFactory.obtenerMinDistribucionLateral(AlgoritmosTSP.CHRISTOFIDES, numProductos, numBaldas, productos, m);
